classdef (Sealed) PylonMEX < handle
% Interface for Basler Pylon USB Cameras
    ...
    properties (SetAccess=private) %class control properties
        ...
        FrameCallbackDuration = NaN(20,1);
...
%         plotdataY = [];
    ...
    methods (Access=private)
        ...
        function drawimage(this)
            ...
            %execute user callback
%             if ~isempty(this.fDrawCallback)&&(isa(this.fDrawCallback,'function_handle')||...
%                 (iscell(this.fDrawCallback)&&isa(this.fDrawCallback{1},'function_handle')))
%                 if iscell(this.fDrawCallback)
%                     this.fDrawCallback{1}(this,this.fDrawCallback{2:end});
%                 else
%                     this.fDrawCallback(this);
%                 end
%             end
...
%             if this.bDrawImage
%                 try
%                     start(this.tDrawTimer)
%                 catch
%                     warning('drawnow timer was not started');
%                 end
%             end
        end
